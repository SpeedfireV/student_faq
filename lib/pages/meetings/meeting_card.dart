        ...
        Expanded(
          child: Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(10),
              onTap: () {
                MyRouter.router.pushNamed(Routes.meeting.name, pathParameters: {"groupId": meeting.groupUid!, "meetingId": meeting.uid!});
              },
              child: Padding(
                padding:
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width:4),
                        Text(
                          Utils.getTimeString(meeting.creationDate) + " - " + (meeting.endDate == null ? "ongoing" : Utils.getTimeString(meeting.endDate!)),
                          style: TextStyle(
                              fontSize: 16, fontWeight: FontWeight.w400),
                        ),
                      ],
                    ),
                    meeting.description != null ?Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
